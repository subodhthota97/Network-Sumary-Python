...
def plot_g_2(hosts, search, field):
    search_results = hosts.aggregate(search, field, num_buckets = 1000)
    data = search_results["buckets"]

    type = {"services.tls.version_selected" : "TLS Version"}
...
#for more findings on TLS
fields_2 = ["services.tls.version_selected"]

for field in fields_2:
    for host in hosts:
        plot_g_2(censys, host, field)